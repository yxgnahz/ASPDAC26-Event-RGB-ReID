...
import sys
sys.path.append('/mnt/proj202/yurui/yurui/Event-ReID/models/mpanet/models')
from resnet import resnet50
from models.mpanet.utils.calc_acc import calc_acc

from models.mpanet.layers import TripletLoss
from models.mpanet.layers import CenterTripletLoss
from models.mpanet.layers import CenterLoss
from models.mpanet.layers import cbam
from models.mpanet.layers import NonLocalBlockND
...
class Baseline(nn.Module):
    ...
    def forward(self, inputs, labels=None, **kwargs):
        # add avg_pool at last layer for video
        # assume the shape of inputs is B,T,C,H,W
        #print("input size here (model)", inputs.shape, labels)
        ...
        # avg_pool on each video
        feats = feats.reshape(torch.Size([-1,T])+feats.shape[1:])
        feats = feats.mean(1)
