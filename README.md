...
The script data_gen.py, which should be placed in the [v2e](https://github.com/SensorsINI/v2e) directory by default, is used to generate the event data for the HITSZ dataset.
