...
import sys
sys.path.append('/mnt/proj202/yurui/yurui/Event-ReID/models/agw')
...
class embed_net(nn.Module):
    ...
    def forward(self, x1, x2, modal=0):
        ...
        # assume the shape of x1, x2 is B,T,C,H,W
        B,T,C,H,W = x1.shape
        x1 = x1.reshape([B*T,C,H,W])
        x2 = x2.reshape([B*T,C,H,W])
        if modal == 0:
        ...
        x_pool = x_pool.reshape(torch.Size([-1,T])+x_pool.shape[1:])
        x_pool = x_pool.mean(1)
